    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @if(request()->has('report_id'))
                    @php
                        $report = \App\Models\MachineReport::find(request()->report_id);
                    @endphp
                    @if($report)
                ...
                <form action="{{ route('actions.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('spare_part_quantity') is-invalid @enderror" id="spare_part_quantity" name="spare_part_quantity" value="{{ old('spare_part_quantity', 1) }}" min="1">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Create Action
                        </button>
                    </div>
                </form>
            </div>
